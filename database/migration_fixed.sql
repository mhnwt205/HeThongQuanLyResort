-- =============================================
-- RESORT MANAGEMENT SYSTEM - SQL SERVER MIGRATION (FIXED)
-- =============================================
...
-- Bảng đặt dịch vụ
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ServiceBookings]') AND type in (N'U'))
BEGIN
...
-- Bảng phiếu xuất kho
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[StockIssues]') AND type in (N'U'))
BEGIN
